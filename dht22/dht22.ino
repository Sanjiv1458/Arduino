...
const char* ssid = "IBN-B"; //--> Your wifi name or SSID.
const char* password = "CUPunjab"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbxTZSqPmqtBXMbQOOoCjr7OAJM_BWlL7R8PIA9oj78CY7Cp788jeW4FRZ58a1bb_W6J"; //--> spreadsheet script ID
//============================================================================== void setup
void setup() {
